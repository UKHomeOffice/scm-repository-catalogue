      ...
      <div className="govuk-form-group">
        ...
        <div style={{paddingTop: 10}}>
          <div style={{
            ...
            <div>
              <select onChange={e => handleSortFieldChanged(e)} className="govuk-select" id="sort" name="sort">
                <option value="owner" selected>Organisation</option>
            ...
            <div>
              ...
              <div>
                <select onChange={e => handleSortDirectionChanged(e)} className="govuk-select" id="sort" name="sort">
